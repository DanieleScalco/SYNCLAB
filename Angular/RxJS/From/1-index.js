// from() è un metodo che ci permette di creare un osservable da uno stream di dati (es: array, evento, promise)
...
from([1, 2, 3, 4, 5, 6, 7, 8, 9]).pipe(
	...
	tap(ele => console.log('tap = ' + ele)), // tap non ritorna nulla, ci permette di prendere un elemento
