...
function getBooks(bookTitle) {
    var from = rxjs.from; // Anche se typescript non riconosce l'oggetto rxjs l'html usando il .js prodotto lo vedrà
...
function searchBooks() {
    ...
    if (searchEle) {
        ...
        filter(function (ele) { return ele.length > 2; }), debounceTime(1000), // Impostiamo un delay di 1s per permettere all'utente di scrivere
